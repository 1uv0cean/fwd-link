...
const KakaoTalkIcon = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 3C5.9 3 1 6.9 1 11.7c0 3.1 2.1 5.8 5.2 7.3-.2.6-.7 2.3-.8 2.7-.1.4.1.5.3.4.2-.1 3.2-2.1 4.5-3 .6.1 1.2.1 1.8.1 6.1 0 11-3.9 11-8.7C23 6.9 18.1 3 12 3z"/>
  </svg>
);
  ...
  return (
    <div className="space-y-3">
      ...
      {isKorean ? (
        ...
        >
          <KakaoTalkIcon className="w-5 h-5 mr-2" />
          카카오톡으로 공유
        </Button>
      ) : (
        <Button
